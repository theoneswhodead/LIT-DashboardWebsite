...
const TextChannelOtherChart = ({ selectedChannel, chartHeight, chartWidth }: { selectedChannel: any, chartHeight: number, chartWidth: string }) => {
...
export default TextChannelOtherChart
