...
const Dashboard = () => {
  ...
  return (
    <div className="text-white flex flex-col w-full px-6 sm:px-[40px] lg:px-[80px] gap-[33px]">
      ...
      <h2 className="text-[28px] sm:text-[32px] lg:text-[40px] font-montserrat font-black text-center p-6">Witaj na głównej stronie dashboardu serwera GoldenLeague</h2>
